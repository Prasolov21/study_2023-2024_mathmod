...
Задания лабораторной работы разделены по вариантам. Мой вариант 39 
...
![(рис. 1.  Формула вычисления варианта и её вывод)](image/7.PNG){#fig:001}

Задача о погоне. Вариант 39:

**На море в тумане катер береговой охраны преследует лодку браконьеров.
Через определенный промежуток времени туман рассеивается, и лодка
обнаруживается на расстоянии 21 км от катера. Затем лодка снова скрывается в
тумане и уходит прямолинейно в неизвестном направлении. Известно, что скорость
катера в 5,5 раза больше скорости браконьерской лодки.**
...
!["Компляция программы lab02.jl"](image/5.png){#fig:004}
!["Компляция программы lab02.jl"](image/6.png){#fig:004}

### Результаты работы кода на Julia

На рис. @fig:005 и @fig:006 изображены итоговые графики траектории движения катера и лодки для случая обоих случаев.

!["Полученный график. Первый случай"](image/10.png){#fig:005}

!["Полученный график. Второй случай"](./image/11.png){#fig:006}
