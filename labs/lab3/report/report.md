...
начальный момент времени страна Х имеет армию численностью 21 050$ человек, а в распоряжении страны У армия численностью в $8 900$ человек. Для упрощения модели считаем, что коэффициенты $a$, $b$, $c$, $h$ постоянны. Также считаем $P(t)$ и $Q(t)$ непрерывными функциями. 

Постройте графики изменения численности войск армии Х и армии У для следующих случаев:

1. Модель боевых действий между регулярными войсками:

$$ {dx\over {dt}} = -0.32x(t)-0.74y(t)+2|sin(t)| $$
$$ {dy\over {dt}} = -0.44x(t)-0.52y(t)+2|cos(t)| $$

2. Модель ведение боевых действий с участием регулярных войск и партизанских отрядов:

$$ {dx\over {dt}} = -0.39x(t)-0.84y(t)+|sin(2t)| $$
$$ {dy\over {dt}} = -0.42x(t)y(t)-0.49y(t)+|cos(2t)| $$
...
function two(du, u, p, t)
    ...
    du[2] = - 0.42*u[1] - 0.15*u[2] + abs (cos(2 * t))
end
...
!["Компляция программы lab03.jl"](image/5.png){#fig:001}

### Результаты работы кода на Julia

На рис. @fig:002 и @fig:003 изображены итоговые графики для обоих случаев.

!["Полученный график Julia. Первый случай"](image/6.png){#fig:002}

!["Полученный график Julia. Второй случай"](image/7.png){#fig:003}

## OpenModelica

Установим OpenModelica:

!["Установщик OpenModelica"](image/1.png){#fig:004}

Откроем OpenModelica:

!["Рабочая область OpenModelica"](image/2.png){#fig:005}
...
!["Полученный график OpenModelica. Первый случай"](image/3.png){#fig:006}

!["Полученный график OpenModelica. Второй случай"](image/4.png){#fig:007}
